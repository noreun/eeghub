function varargout = interp_ungridded_modified(pntin, pntout, varargin)
...
valin          = keyval('data',          varargin);   % functional data defined at pntin

hasval  = ~isempty(valin);
npntin  = size(pntin, 1);
